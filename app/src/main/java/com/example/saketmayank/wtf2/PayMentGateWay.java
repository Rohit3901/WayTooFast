...
//    String salt="ZhraT96O"; // live
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            String data[] = getRechargeAmt.split(" ");
...
return false;
            ...
            webView.setVisibility(0b0);
            webView.getSettings().setBuiltInZoomControls(true);
            webView.getSettings().setCacheMode(0b10);
        ...
        private final class PayUJavaScriptInterface {
            ...
            public void success(long id, final String paymentId) {
                mHandler.post(new Runnable() {
                   ...
                   finish();*/
                        // new PostRechargeData().execute();
                        Intent intent=new Intent(PayMentGateWay.this,finalpage.class);
